...
public class GetNewsletterQueryResultHandler : IRequestHandler<GetNewsletterQueryResult, List<GetNewsletterQueryResult>>
{
    ...
    public async Task<List<GetNewsletterQueryResult>> Handle(GetNewsletterQueryResult request, CancellationToken cancellationToken)
    {
